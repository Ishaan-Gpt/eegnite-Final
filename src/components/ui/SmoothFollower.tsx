...
export default function SmoothFollower() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[1]">
      {/* Glowing dot */}
      <div
        className="absolute rounded-full bg-white dark:bg-white smooth-follower-dot"
        style={{
          width: "12px",
          height: "12px",
      ...
      {/* Glowing border */}
      <div
        className={"absolute rounded-full border border-[#ffb347] dark:border-[#ffb347] smooth-follower-border"}
        style={{

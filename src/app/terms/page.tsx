...
export const metadata: Metadata = {
    title: "Terms & Conditions | EEGNITE",
    description: "Read EEGNITE's Terms and Conditions governing your use of our website and services.",
    alternates: {
        canonical: "https://www.eegnite.com/terms",
    },
};
...
export default function TermsPage() {
    return (
        <main className="min-h-screen bg-white">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-black/5">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <img src="/images/logos/images/logos/eegnite-logo.png" alt="EEGNITE" className="h-8 w-auto" />
            ...
            {/* Hero Header */}
            <div className="blog-hero-animate relative pt-32 pb-20 overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-6 md:px-12 pb-24">
                <div className="bg-gradient-to-br from-white to-gray-50 border border-black/5 rounded-3xl p-8 md:p-12 shadow-xl">
                    <div className="prose prose-lg max-w-none">
                        <p className="text-lg text-black/70 leading-relaxed">
                            Welcome to EEGNITE. These Terms and Conditions constitute a legally binding agreement between you and EEGNITE concerning your access to and use of the https://www.eegnite.com website.
                        </p>

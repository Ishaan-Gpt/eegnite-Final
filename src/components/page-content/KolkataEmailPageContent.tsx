                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 w-full h-full flex items-center justify-center">
                        <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden border border-black/5 shadow-xl group">
                            <img
                                src="/images/services/industries-served-email-kolkata.webp"
                                alt="Industries served for email marketing in Kolkata by EEGNITE"
                    ...
                    <div className="max-w-[1400px] mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
                            ...
                            <div className="lg:col-span-5 w-full h-full flex items-center justify-center">
                                <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden border border-black/5 shadow-xl group">
                                    <img
                                        src="/images/services/kolkata-email-pain-points.webp"
                                        alt="Kolkata business email marketing pain points"
                                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                                        loading="eager"
                                    />
                                </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                            ...
                            <div className="lg:col-span-6 space-y-6">
                                ...
                                <div className="relative w-full aspect-[16/10] rounded-[2.5rem] overflow-hidden border border-black/5 shadow-xl group">
                                    <img
                                        src="/images/services/kolkata-email-opportunity.webp"
                                        alt="Kolkata business email marketing opportunity"
                                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                                        loading="eager"
                                    />
                                </div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-4 md:gap-6 w-full pt-2">
                                    <div className="bg-white/80 backdrop-blur-md p-6 md:p-8 rounded-[2rem] border border-black/5 flex flex-col justify-between min-h-[160px] hover:scale-[1.03] transition-all duration-500 shadow-sm hover:shadow-[0_20px_50px_rgba(232,106,0,0.03)] relative overflow-hidden group">
                                        ...
                                        <span className="text-4xl md:text-5xl font-extrabold text-[#FF6105] tracking-tighter leading-none drop-shadow-[0_2px_10px_rgba(255,97,5,0.1)]">4200%</span>
                                        <div className="mt-4">
                                            <h4 className="text-xs md:text-sm font-bold uppercase tracking-wider text-black mb-1">Average ROI</h4>
                                    ...
                                    <div className="bg-white/80 backdrop-blur-md p-6 md:p-8 rounded-[2rem] border border-black/5 flex flex-col justify-between min-h-[160px] hover:scale-[1.03] transition-all duration-500 shadow-sm hover:shadow-[0_20px_50px_rgba(232,106,0,0.03)] relative overflow-hidden group">
                                        <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#FF6105]/5 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700" />
                                        <span className="text-4xl md:text-5xl font-extrabold text-[#FF6105] tracking-tighter leading-none drop-shadow-[0_2px_10px_rgba(255,97,5,0.1)]">81%</span>
                                        <div className="mt-4">
                                            <h4 className="text-xs md:text-sm font-bold uppercase tracking-wider text-black mb-1">Primary Acquisition Channel</h4>
                                            <p className="text-black/50 text-xs md:text-sm leading-relaxed">of small and medium-sized businesses report email marketing as primary acquisition channel.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

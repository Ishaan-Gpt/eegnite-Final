            ...
            <div className="max-w-[1400px] mx-auto px-6">
                ...
                <div className="max-w-4xl mx-auto mb-12 md:mb-16 text-center">
                    <h2 className="text-3xl md:text-5xl font-bold uppercase tracking-tight text-black mb-4 leading-tight">
                        INDUSTRIES WE HELP GROW <span className="text-[#FF6105]">IN KOLKATA</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 w-full h-full flex items-center justify-center">
                        <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden border border-black/5 shadow-xl group">
                            <img
                                src="/images/services/industries-served-webdev-kolkata.webp"
                                alt="Industries served for web design development in Kolkata by EEGNITE"
                    ...
                    <div className="max-w-[1400px] mx-auto px-6">
                        <div className="max-w-4xl mx-auto mb-12 md:mb-16 text-center">
                            <h2 className="text-3xl md:text-5xl font-bold uppercase tracking-tight text-black mb-4">
                                SIGNS YOUR KOLKATA BUSINESS <span className="text-[#FF6105]">NEEDS A NEW WEBSITE DESIGN</span>
                            </h2>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
                            ...
                            <div className="lg:col-span-5 w-full h-full flex items-center justify-center">
                                <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden border border-black/5 shadow-xl group">
                                    <img
                                        src="/images/services/kolkata-webdev-pain-points.webp"
                                        alt="Kolkata business web design development pain points"
                                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                                        loading="eager"
                                    />
                                </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                            ...
                            <div className="lg:col-span-6 space-y-6">
                                ...
                                <div className="relative w-full aspect-[16/10] rounded-[2.5rem] overflow-hidden border border-black/5 shadow-xl group">
                                    <img
                                        src="/images/services/kolkata-webdev-opportunity.webp"
                                        alt="Kolkata business web design development opportunity"
                                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                                        loading="eager"
                                    />
                                </div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-4 md:gap-6 w-full pt-2">
                                    <div className="bg-white/80 backdrop-blur-md p-6 md:p-8 rounded-[2rem] border border-black/5 flex flex-col justify-between min-h-[160px] hover:scale-[1.03] transition-all duration-500 shadow-sm hover:shadow-[0_20px_50px_rgba(232,106,0,0.03)] relative overflow-hidden group">
                                        ...
                                        <span className="text-4xl md:text-5xl font-extrabold text-[#FF6105] tracking-tighter leading-none drop-shadow-[0_2px_10px_rgba(255,97,5,0.1)]">94%</span>
                                        <div className="mt-4">
                                            <h4 className="text-xs md:text-sm font-bold uppercase tracking-wider text-black mb-1">First Impressions Online</h4>
                                            <p className="text-black/50 text-xs md:text-sm leading-relaxed">are design-related. A poor website design causes visitors to distrust the business.</p>
                                        </div>
                                    </div>
                                    <div className="bg-white/80 backdrop-blur-md p-6 md:p-8 rounded-[2rem] border border-black/5 flex flex-col justify-between min-h-[160px] hover:scale-[1.03] transition-all duration-500 shadow-sm hover:shadow-[0_20px_50px_rgba(232,106,0,0.03)] relative overflow-hidden group">
                                        <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#FF6105]/5 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700" />
                                        <span className="text-4xl md:text-5xl font-extrabold text-[#FF6105] tracking-tighter leading-none drop-shadow-[0_2px_10px_rgba(255,97,5,0.1)]">75%</span>
                                        <div className="mt-4">
                                            <h4 className="text-xs md:text-sm font-bold uppercase tracking-wider text-black mb-1">Credibility Judged</h4>
                                            <p className="text-black/50 text-xs md:text-sm leading-relaxed">of consumers admit to judging a business's credibility based on website design.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
import {
    ShoppingBag, Target, HeartPulse, Store, Factory, Briefcase,
    ArrowRight, Check
} from "lucide-react";
            ...
            <div className="max-w-6xl mx-auto w-full text-center relative z-10 flex flex-col items-center">
                ...
                >
                    ...
                    <h1 className="text-[8vw] xs:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold uppercase tracking-tighter leading-[1.05] mb-6 text-black max-w-[1300px] mx-auto">
                        SECTOR-SPECIFIC <br />
                        <span className="text-[#FF6105]">GROWTH PROGRAMS</span>
                    </h1>
                </motion.div>
                ...
                >
                    <p className="text-sm md:text-xl text-black/60 font-medium leading-relaxed px-4">
                        We build highly customized performance marketing and conversion systems designed exactly around your margins, regulatory guidelines, and buyer behavior cycles. No copy-paste templates. Pure focused growth.
                    </p>
                </motion.div>
            </div>
        </section>
...
function IndustriesGrid() {
    const industries = [
        {
            title: "E-commerce",
            desc: "Scale your store's transaction volume, customer lifetime value, and return on ad spend through automated flows and purchase intent campaigns.",
            bulletPoints: [
                "Multi-Channel Conversion Optimization",
                "High-ROI Paid Social & Retention Flows",
                "Shopify/eCommerce SEO & Category Audit"
            ],
            icon: ShoppingBag,
            href: "/industries/e-commerce"
        },
        {
            title: "B2B and Lead Gen",
            desc: "Deploy target accounts paid placement, search intent capture, and credibility-driven content to fill your pipeline with high-value decision-makers.",
            bulletPoints: [
                "Search & Content Pipeline Targeting",
                "Decision-Maker LinkedIn Campaigns",
                "Full-Funnel Attribution & CRM Setup"
            ],
            icon: Target,
        ...
        },
        {
            ...
            desc: "Increase booking rates, patient acquisition, and practitioner branding through compliant search visibility campaigns and trust-first content strategies.",
            bulletPoints: [
                "HIPAA-Compliant Patient Acquisition",
                "Trust-First Brand & Treatment Authority",
                "Geo-Targeted Local Search & Reviews"
            ],
            icon: HeartPulse,
        ...
        },
        {
            ...
            desc: "Dominate local areas, grow in-store footfall, and scale your online checkout simultaneously through localized SEO and social commerce systems.",
            bulletPoints: [
                "Location-Based Local Search Dominance",
                "Foot-Traffic & Online Sales Multipliers",
                "Social Commerce & Retention Systems"
            ],
            icon: Store,
        ...
        },
        {
            ...
            desc: "Target B2B industrial buyers, procurement managers, and catalog orders through highly technical spec keyword strategies and content programs.",
            bulletPoints: [
                "Procurement-Targeted Search Strategies",
                "Technical Spec Content Authority",
                "High-Value Industrial Inquiries Setup"
            ],
            icon: Factory,
        ...
        },
        {
            ...
            desc: "Establish your firm's authority, build client credibility, and generate constant advisory enquiries through thought leadership search positioning.",
            bulletPoints: [
                "Thought Leadership Content Authority",
                "Credibility-Driven Client Pipelines",
                "Firm-Branding & Automation Integrations"
            ],
            icon: Briefcase,

...
export default function BlogPage() {
    return (
        <main className="min-h-screen bg-white text-black font-sans selection:bg-[#FF6105] selection:text-white overflow-x-hidden">
            ...
            {/* --- HERO SECTION (100vh) --- */}
            <section className="min-h-screen w-full relative flex items-center justify-center overflow-hidden py-32 md:py-0">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-20">
                    ...
                    >
                        ...
                        <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold uppercase tracking-tighter leading-[0.9] text-[#2A1810]">
                            {featuredPost.title}
                        </h1>

                        <p className="text-lg md:text-xl text-[#6B5545] max-w-2xl font-normal leading-relaxed">
                            {featuredPost.excerpt}
                        </p>

                        <div className="flex flex-wrap items-center gap-6 pt-4">
                            <Button asChild className="rounded-full bg-[#FF6105] hover:bg-black text-white px-8 py-6 md:px-10 md:py-7 text-sm font-bold uppercase tracking-widest shadow-[0_20px_40px_rgba(255,97,5,0.3)] hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <section className="py-32 px-6 lg:px-12 bg-white relative">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 auto-rows-[600px]">

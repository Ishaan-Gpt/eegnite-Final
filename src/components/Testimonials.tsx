...
const testimonials = [
    ...
    {
        quote: "I've had the opportunity to work closely with Anish for almost four years, and during that time I've seen firsthand how consistently he brings clarity, structure, and long-term thinking to every challenge. He is driven, focused, and genuinely committed to solving complex problems in a way that not only fixes the issue in front of him but strengthens the entire system around it.",
        name: "Andre Ponti",
